...
<body>
	 <h3>Datos de ubicaciones</h3>
	 
<a href="?page=ubicacion_form" class="btn btn-primary">Añadir nueva ubicación</a>
 <?php
	 if ($nivel >= 0){	 
...
echo "";
    ...
    <div class="container">
        ...
        <table id="table"
			 ...
			 data-toolbar="#show"
			 data-flat="true"
             data-url="administracion/vistas/ubicacion.php">
            <thead>
            ...
            <tr>         
                ...
                <th data-field="ubicacion" data-type="numeric">Ubicación</th> 
...
<script>
    ...
    $(function () {
      ...
      borrar=confirm("Eliminar lector seleccionado : " + ids);
       if(borrar)
       window.location = "index.php?page=del_ubicacion&datos=" + ids;
            else
      alert('No se ha podido eliminar el lector..');
      
 $('#table').bootstrapTable('refresh', {url: 'administracion/vistas/ubicaciones.php'});
        });
    });
 });
</script>
...
<script>
    ...
    function dataFormater(value, row, index) {
       ...
       // <a href='?page=empresas_form' class='btn btn-primary'>Añadir empresas</a> 
         strHTML += "<a href='index.php?page=ubicacion_form&datos=" + id + "' class='btn btn-primary btn-sm'><span class='glyphicon glyphicon-edit'></span>&nbsp;&nbsp;Editar</a>";
        strHTML += "</div>";
